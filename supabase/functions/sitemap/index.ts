...
Deno.serve(async (req) => {
  ...
  const staticPages = [
    ...
    { loc: "/tapas-alternative", priority: "0.7", freq: "monthly" },
    { loc: "/webtoon-alternative", priority: "0.7", freq: "monthly" },
    { loc: "/publish-manhwa", priority: "0.7", freq: "monthly" },
    { loc: "/genre/action", priority: "0.8", freq: "weekly" },
    { loc: "/genre/romance", priority: "0.8", freq: "weekly" },
    { loc: "/genre/fantasy", priority: "0.8", freq: "weekly" },
    { loc: "/genre/isekai", priority: "0.8", freq: "weekly" },
    { loc: "/genre/martial-arts", priority: "0.7", freq: "weekly" },
    { loc: "/genre/horror", priority: "0.7", freq: "weekly" },
    { loc: "/genre/comedy", priority: "0.7", freq: "weekly" },
    { loc: "/genre/drama", priority: "0.7", freq: "weekly" },
    { loc: "/genre/slice-of-life", priority: "0.7", freq: "weekly" },
    { loc: "/genre/school-life", priority: "0.7", freq: "weekly" },
    { loc: "/genre/sci-fi", priority: "0.7", freq: "weekly" },
    { loc: "/genre/adventure", priority: "0.7", freq: "weekly" },
    { loc: "/terms", priority: "0.3", freq: "monthly" },
    { loc: "/privacy", priority: "0.3", freq: "monthly" },
    { loc: "/dmca", priority: "0.3", freq: "monthly" },
    { loc: "/content-guidelines", priority: "0.3", freq: "monthly" },
    { loc: "/cookie-policy", priority: "0.3", freq: "monthly" },
    { loc: "/disclaimer", priority: "0.3", freq: "monthly" },
  ];
