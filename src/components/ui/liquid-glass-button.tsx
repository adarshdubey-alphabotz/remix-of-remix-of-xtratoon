...
> = {
  ...
  success: {
    outer: "bg-gradient-to-b from-[hsl(162,100%,18%)] to-[hsl(149,46%,70%)]",
    inner: "bg-gradient-to-b from-[hsl(151,68%,93%)] via-[hsl(173,100%,10%)] to-[hsl(151,58%,88%)]",
    button: "bg-gradient-to-b from-[hsl(163,38%,73%)] to-[hsl(165,40%,40%)]",
    textColor: "text-primary-foreground",
    textShadow: "[text-shadow:_0_-1px_0_rgb(6_78_59_/_100%)]",
  },
  error: {
    outer: "bg-gradient-to-b from-[hsl(0,100%,18%)] to-[hsl(358,100%,84%)]",
    inner: "bg-gradient-to-b from-[hsl(0,100%,93%)] via-[hsl(359,100%,20%)] to-[hsl(0,100%,95%)]",
    button: "bg-gradient-to-b from-[hsl(359,79%,75%)] to-[hsl(359,32%,49%)]",
    textColor: "text-primary-foreground",
    textShadow: "[text-shadow:_0_-1px_0_rgb(146_64_14_/_100%)]",
  },
  gold: {
    outer: "bg-gradient-to-b from-[hsl(46,100%,28%)] to-[hsl(46,67%,74%)]",
    inner: "bg-gradient-to-b from-[hsl(46,100%,93%)] via-[hsl(47,91%,17%)] to-[hsl(46,100%,85%)]",
    button: "bg-gradient-to-b from-[hsl(46,100%,82%)] to-[hsl(43,42%,43%)]",
    textColor: "text-primary-foreground",
    textShadow: "[text-shadow:_0_-1px_0_rgb(178_140_2_/_100%)]",
  },
  bronze: {
    outer: "bg-gradient-to-b from-[hsl(24,75%,30%)] to-[hsl(23,66%,72%)]",
    inner: "bg-gradient-to-b from-[hsl(21,53%,78%)] via-[hsl(24,100%,19%)] to-[hsl(23,100%,88%)]",
    button: "bg-gradient-to-b from-[hsl(23,100%,89%)] to-[hsl(27,44%,44%)]",
    textColor: "text-primary-foreground",
