    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-16">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
          ...
          <button onClick={handleGoogleSignup} disabled={submitting} className="w-full flex items-center justify-center gap-3 py-3 text-sm font-medium border border-border rounded-xl hover:bg-muted/40 transition-colors disabled:opacity-50">
